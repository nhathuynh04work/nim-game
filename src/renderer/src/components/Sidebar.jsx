...
function Sidebar() {
    return (
        <div className="overflow-auto w-[18vw] py-12 px-8 lowercase tracking-widest dark:bg-zinc-900 flex flex-col h-full gap-4">
            {/* home */}
            <SidebarNavItem
                to="/"
                icon={
            ...
            {/* spacer to push GitHub to bottom */}
            <div className="flex-grow" />

            <div className="flex w-full justify-center gap-4">
                {/* facebook */}
                <div
                    onClick={() => window.api.openExternal("https://www.facebook.com/nihonasm")}
                ...
                {/* instagram */}
                <div
                    onClick={() => window.api.openExternal("https://www.instagram.com/nihonasm")}
                    className="opacity-40 hover:opacity-70 cursor-pointer"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <div
                    onClick={() =>
                        window.api.openExternal("https://github.com/nhathuynh04work/nim-game")
                    }
                    className="opacity-40 hover:opacity-70 cursor-pointer"
                >
                    <svg
